...
window.CREATIVITY_CARDS_CONFIG = {
    ...
    start_subtitle: 'בלק אאוט שכזה, או שפשוט נגמרו כל הרעיונות? הכרטיסים האלה נבנו במיוחד עם כל השיטות והרעיונות שלי לפיתוח ואימון יצירתיות, לפתוח את הראש לרגעים האלה שבהם הכי צריכים את זה. השיטות בדוקות ומנוסות וכל אחת יכולה להיות יעילה ואפקטיבית, אם רק תשתמשו בה!\nאז עברו למסך הבא, ולחיי היצירתיות!',
